...
import { TeamEventTypeResponseHost } from "@calcom/platform-types";
...
type Input = Pick<
  ...
  | "periodEndDate"
>;
export declare class OutputOrganizationsEventTypesService {
  ...
  getResponseTeamEventType(databaseEventType: Input): Promise<{
  ...
  getManagedEventTypeHosts(eventTypeId: number): Promise<TeamEventTypeResponseHost[]>;
  transformHosts(
    databaseHosts: Host[],
