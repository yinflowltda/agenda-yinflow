  ...
  async canActivate(context) {
    ...
    org &&
      (await this.redisService.redis.set(
        REDIS_CACHE_KEY,
        JSON.stringify({ org: org, canAccess }),
        "EX",
        300
      ));
    return canAccess;
...
IsAdminAPIEnabledGuard = __decorate(
  [
...
exports.IsAdminAPIEnabledGuard = IsAdminAPIEnabledGuard;
//# sourceMappingURL=is-admin-api-enabled.guard.js.map
