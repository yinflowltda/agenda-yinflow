...
exports.GcalAuthUrlOutput = void 0;
...
class AuthUrlData {
  static _OPENAPI_METADATA_FACTORY() {
    return { authUrl: { required: true, type: () => String } };
  }
}
__decorate(
  [(0, class_validator_1.IsString)(), __metadata("design:type", String)],
  AuthUrlData.prototype,
  "authUrl",
  void 0
);
class GcalAuthUrlOutput {
  static _OPENAPI_METADATA_FACTORY() {
    return {
      status: { required: true, type: () => Object },
      data: { required: true, type: () => AuthUrlData },
    };
  }
}
__decorate(
  ...
  GcalAuthUrlOutput.prototype,
  "status",
  void 0
);
__decorate(
  [
    (0, class_transformer_1.Type)(() => AuthUrlData),
    (0, class_validator_1.ValidateNested)(),
    __metadata("design:type", AuthUrlData),
  ],
  GcalAuthUrlOutput.prototype,
  "data",
  void 0
);
exports.GcalAuthUrlOutput = GcalAuthUrlOutput;
//# sourceMappingURL=auth-url.output.js.map
