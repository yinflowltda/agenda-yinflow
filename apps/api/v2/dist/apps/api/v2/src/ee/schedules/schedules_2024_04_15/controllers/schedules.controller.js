...
exports.SchedulesController_2024_04_15 = void 0;
const openapi = require("@nestjs/swagger");
const common_1 = require("@nestjs/common");
const swagger_1 = require("@nestjs/swagger");
const throttler_1 = require("@nestjs/throttler");
const get_default_schedule_output_1 = require("../outputs/get-default-schedule.output");
...
let SchedulesController_2024_04_15 = class SchedulesController_2024_04_15 {
...
__decorate(
  [
    ...
    openapi.ApiResponse({
      status: 201,
      type: require("../outputs/create-schedule.output").CreateScheduleOutput_2024_04_15,
    }),
    __param(0, (0, get_user_decorator_1.GetUser)()),
    __param(1, (0, common_1.Body)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object, create_schedule_input_1.CreateScheduleInput_2024_04_15]),
    __metadata("design:returntype", Promise),
  ],
  SchedulesController_2024_04_15.prototype,
  "createSchedule",
  null
);
__decorate(
  [
    ...
    (0, swagger_1.ApiResponse)({
      ...
      type: get_default_schedule_output_1.GetDefaultScheduleOutput_2024_04_15,
    }),
...
__decorate(
  [
    ...
    openapi.ApiResponse({
      status: 200,
      type: require("../outputs/get-schedule.output").GetScheduleOutput_2024_04_15,
    }),
    __param(0, (0, get_user_decorator_1.GetUser)()),
...
__decorate(
  [
    ...
    openapi.ApiResponse({
      status: 200,
      type: require("../outputs/get-schedules.output").GetSchedulesOutput_2024_04_15,
    }),
    __param(0, (0, get_user_decorator_1.GetUser)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object]),
...
__decorate(
  [
    ...
    openapi.ApiResponse({
      status: 200,
      type: require("../outputs/update-schedule.output").UpdateScheduleOutput_2024_04_15,
    }),
    __param(0, (0, get_user_decorator_1.GetUser)()),
    __param(1, (0, common_1.Body)()),
    __param(2, (0, common_1.Param)("scheduleId")),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object, platform_types_1.UpdateScheduleInput_2024_04_15, String]),
    __metadata("design:returntype", Promise),
  ],
  SchedulesController_2024_04_15.prototype,
  "updateSchedule",
...
__decorate(
  [
    ...
    openapi.ApiResponse({
      ...
      type: require("../outputs/delete-schedule.output").DeleteScheduleOutput_2024_04_15,
    }),
...
SchedulesController_2024_04_15 = __decorate(
  [
    (0, common_1.Controller)({
      path: "/v2/schedules",
      version: api_versions_1.VERSION_2024_04_15_VALUE,
    }),
    (0, common_1.UseGuards)(api_auth_guard_1.ApiAuthGuard, permissions_guard_1.PermissionsGuard),
    (0, swagger_1.ApiTags)("Schedules"),
    __metadata("design:paramtypes", [schedules_service_1.SchedulesService_2024_04_15]),
  ],
  SchedulesController_2024_04_15
);
exports.SchedulesController_2024_04_15 = SchedulesController_2024_04_15;
