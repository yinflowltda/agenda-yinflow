...
exports.GetEventTypesPublicOutput = void 0;
...
class GetEventTypesPublicOutput {
  static _OPENAPI_METADATA_FACTORY() {
    return {
      status: { required: true, type: () => Object },
      data: { required: true, type: () => [PublicEventType] },
    };
  }
}
__decorate(
  ...
  GetEventTypesPublicOutput.prototype,
  "status",
  void 0
);
__decorate(
  [
    ...
    (0, class_transformer_1.Type)(() => PublicEventType),
...
exports.GetEventTypesPublicOutput = GetEventTypesPublicOutput;
//# sourceMappingURL=get-event-types-public.output.js.map
